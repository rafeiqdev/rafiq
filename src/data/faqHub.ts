...
export const FAQ_HUB: Record<FaqHubLanguage, FaqHubContent> = {
  "ar": {
    ...
    "metaDescription": "إجابات واضحة عن أكثر الأسئلة تكرارًا لدى الأجانب في إسطنبول: الإقامة التركية، فتح الحساب البنكي، السكن، الصحة والحياة اليومية، مع طريقة التواصل مع رفيق.",
  ...
  "ru": {
    ...
    "metaDescription": "Прямые ответы на самые частые вопросы иностранцев о турецком ВНЖ, банковских счетах, жилье и повседневной жизни в Стамбуле — и о том, чем может помочь Rafiq.",
  ...
  "fa": {
    ...
    "metaDescription": "پاسخ‌های روشن به رایج‌ترین پرسش‌های خارجی‌ها درباره اقامت ترکیه، حساب بانکی، مسکن و زندگی روزمره در استانبول، و اینکه رفیق چطور می‌تواند کمک کند.",
