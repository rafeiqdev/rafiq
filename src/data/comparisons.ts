...
export const COMPARISONS: Record<string, Record<ComparisonLanguage, Comparison>> = {
  "residency-diy": {
    "ar": {
      ...
      "metaDescription": "مقارنة موضوعية بين تنسيق الإقامة التركية عبر رفيق والتقديم بنفسك في إسطنبول: عائق اللغة، الوقت، متابعة الملف بعد الموعد، وما لا يستطيع أي طرف أن يضمنه.",
    ...
    "fa": {
      ...
      "metaDescription": "مقایسه‌ای صریح بین هماهنگی اقامت ترکیه از طریق رفیق و اقدام شخصی در استانبول: مانع زبان، زمان، پیگیری پرونده بعد از نوبت و آنچه هیچ‌کدام تضمین نمی‌کنند.",
  ...
  "bank-account-alone": {
    "ar": {
      ...
      "metaDescription": "مقارنة صريحة بين فتح حساب بنكي في تركيا بمرافقة رفيق والذهاب إلى البنك بنفسك: اللغة، المستندات التي يطلبها البنك، وقرار البنك النهائي الذي لا يملكه أحد غيره.",
    ...
    "fa": {
      ...
      "metaDescription": "مقایسه‌ای صادقانه بین افتتاح حساب بانکی ترکیه با همراهی رفیق و مراجعه شخصی به بانک: زبان، مدارکی که بانک می‌خواهد و تصمیم نهایی که فقط با خود بانک است.",
