...
export const SERVICE_KEYWORDS: Record<string, string> = {
  ...
  'legal-family': 'زواج طلاق حضانة احوال شخصية divorce custody bosanma velayet زواج رسمي عقد زواج اجانب marriage evlilik',
  ...
  'tour-airport': 'استقبال مطار توصيل سيارة airport pickup transfer havalimani karsilama في اي بي مطار استقبال خاص vip airport reception karsilama',
  ...
  'tr-companion': 'مترجم مرافق ترجمة مستشفى دوائر tercuman interpreter translator companion ترجمة طبية طبيب مستشفى medical interpreter saglik تسوق مرافقة shopping alisveris personal shopper',
  'tr-sworn': 'ترجمة محلفة معتمدة تصديق yeminli sworn certified translation ترجمة وثائق اوراق document translation belge ceviri',
  ...
  'health-hospitals': 'مستشفى خاص علاج قسم عربي hospital hastane treatment طبيب عربي دكتور عيادة doctor doktor clinic موعد طبي حجز دكتور appointment randevu medical',
  ...
  'edu-university': 'تسجيل جامعة قبول جامعي university universite admission استشارة اختيار جامعة تخصص توجيه university program selection advice danismanlik',
  ...
  'biz-licenses': 'رخصة عمل تصريح بلدية ruhsat business license مطعم كافيه رخصة فتح restaurant cafe ruhsat license',
...
/**
 * Services that were folded into another one (they duplicated it for the
 * visitor). Old links, saved requests and ads still carry these ids, so they
 * resolve to the service that absorbed them. Mirrored as 301s in vercel.json.
 */
export const MERGED_SERVICE_IDS: Record<string, string> = {
  'tour-vip': 'tour-airport',
  'tr-docs': 'tr-sworn',
  'tr-medical': 'tr-companion',
  'daily-shopping': 'tr-companion',
  'health-doctors': 'health-hospitals',
  'health-appointments': 'health-hospitals',
  'edu-advisory': 'edu-university',
  'biz-restaurant': 'biz-licenses',
  'daily-marriage': 'legal-family',
};
...
export const SERVICES: ServiceItem[] = [
  ...
  { id: 'res-tax', category: 'residency', type: 'partner', icon: 'receipt', title: { ar: 'استخراج الرقم الضريبي', en: 'Tax number (Vergi No)', tr: 'Vergi numarası çıkarma' }, desc: { ar: 'مجاني وسريع — نتولّاه عنك', en: 'Partner assistance with Turkish tax number applications', tr: 'Hızlı — sizin adınıza hallederiz' } },
  ...
  { id: 'tel-address', category: 'residency', type: 'direct', icon: 'map-pin', title: { ar: 'تسجيل العنوان (Adres Kaydı)', en: 'Address registration (Adres Kaydı)', tr: 'Adres kaydı' }, desc: { ar: 'تسجيل عنوان السكن رسمياً', en: 'Assistance with address registration and change procedures', tr: 'İkamet adresini resmen kaydetme' } },
  ...
  { id: 'legal-family', category: 'legal', type: 'partner', icon: 'users', title: { ar: 'الزواج الرسمي والأحوال الشخصية (طلاق/حضانة)', en: 'Marriage registration & family law (divorce/custody)', tr: 'Resmî evlilik ve aile hukuku (boşanma/velayet)' }, desc: { ar: 'إجراءات الزواج الرسمي للأجانب وقضايا الأحوال الشخصية', en: 'Official marriage procedures for foreigners and family-law cases', tr: 'Yabancılar için resmî evlilik işlemleri ve aile hukuku davaları' } },
  { id: 'legal-liquidation', category: 'legal', type: 'partner', icon: 'x-circle', title: { ar: 'تصفية وإغلاق الشركات', en: 'Company liquidation & closure', tr: 'Şirket tasfiyesi ve kapanışı' }, desc: { ar: 'إغلاق الشركة قانونياً', en: 'Partner assistance with company liquidation procedures', tr: 'Şirketi yasal olarak kapatma' } },
  { id: 'legal-consult', category: 'legal', type: 'partner', icon: 'message-circle', title: { ar: 'استشارة قانونية عامة', en: 'General legal consultation', tr: 'Genel hukuki danışmanlık' }, desc: { ar: 'استشارة مع محامٍ معتمد', en: 'Legal consultation through partner lawyers', tr: 'Onaylı avukatla danışma' } },
  ...
  { id: 're-buy', category: 'realestate', type: 'partner', icon: 'building', title: { ar: 'بيع وشراء العقارات', en: 'Buying & selling property', tr: 'Gayrimenkul alım-satım' }, desc: { ar: 'وساطة بيع وشراء موثوقة', en: 'Partner support for property sale and purchase processes', tr: 'Güvenilir alım-satım aracılığı' } },
  { id: 're-citizenship', category: 'realestate', type: 'partner', icon: 'star', title: { ar: 'عقارات ضمن حد الاستثمار للجنسية', en: 'Citizenship-threshold property', tr: 'Vatandaşlığa uygun gayrimenkul' }, desc: { ar: 'عقارات تستوفي حد الاستثمار المطلوب — الأهلية للتقدم وليست ضمانًا للموافقة', en: 'Property meeting the required investment amount — eligible to apply, not a guarantee of approval', tr: 'Vatandaşlık şartını karşılayan mülk' } },
  ...
  { id: 'tour-airport', category: 'tourism', type: 'direct', icon: 'plane', title: { ar: 'استقبال وتوصيل المطار (عادي أو VIP)', en: 'Airport pickup & drop-off (standard or VIP)', tr: 'Havalimanı karşılama ve transfer (standart veya VIP)' }, desc: { ar: 'سيارتنا الخاصة وسائق ناطق بالعربية', en: 'Airport transfer coordination through service partners', tr: 'Kendi aracımız, Arapça konuşan şoför' } },
  { id: 'tour-daytrips', category: 'tourism', type: 'direct', icon: 'map-pin', title: { ar: 'جولات يومية داخل إسطنبول', en: 'Daily tours within Istanbul', tr: 'İstanbul içi günlük turlar' }, desc: { ar: 'جولات بمرشد ناطق بالعربية', en: 'Day-trip planning and coordination through service partners', tr: 'Arapça rehberli turlar' } },
  ...
  { id: 'tour-carrental', category: 'tourism', type: 'direct', icon: 'car', title: { ar: 'تأجير سيارات طويل المدى', en: 'Long-term car rental', tr: 'Uzun dönem araç kiralama' }, desc: { ar: 'تأجير شهري بأسعار مناسبة', en: 'Daily and monthly car rental options through partners', tr: 'Uygun fiyatlı aylık kiralama' } },
  { id: 'tour-hotels', category: 'tourism', type: 'direct', icon: 'hotel', title: { ar: 'حجز الفنادق', en: 'Hotel booking', tr: 'Otel rezervasyonu' }, desc: { ar: 'حجز فنادق بأفضل الأسعار', en: 'Hotel search and booking support through partners', tr: 'En iyi fiyatlarla otel' } },
  ...
  { id: 'tr-companion', category: 'translation', type: 'direct', icon: 'languages', title: { ar: 'مترجم مرافق (مستشفى وعلاج/دوائر/تسوّق)', en: 'Companion interpreter (hospital & treatment/offices/shopping)', tr: 'Refakatçi tercüman (hastane ve tedavi/daire/alışveriş)' }, desc: { ar: 'يرافقك ميدانياً ويترجم لك', en: 'On-site interpreter with you', tr: 'Yanınızda yerinde tercüman' } },
  { id: 'tr-sworn', category: 'translation', type: 'partner', icon: 'stamp', title: { ar: 'ترجمة الوثائق الرسمية والمحلّفة', en: 'Official & sworn document translation', tr: 'Resmî ve yeminli belge tercümesi' }, desc: { ar: 'ترجمة دقيقة ومعتمدة قانونياً لوثائقك', en: 'Accurate, legally certified translation of your documents', tr: 'Belgelerinizin doğru ve yasal onaylı tercümesi' } },
  { id: 'tr-notary', category: 'translation', type: 'partner', icon: 'stamp', title: { ar: 'تصديق النوتر والأبوستيل', en: 'Notary & apostille', tr: 'Noter ve apostil' }, desc: { ar: 'تصديق رسمي للوثائق', en: 'Official document certification', tr: 'Resmî belge onayı' } },
  ...
  // ───────────────────────── Health (partner) ─────────────────────────
  { id: 'health-hospitals', category: 'health', type: 'partner', icon: 'building', title: { ar: 'مستشفيات وأطباء ناطقون بالعربية وحجز المواعيد', en: 'Hospitals, Arabic-speaking doctors & appointments', tr: 'Hastaneler, Arapça konuşan doktorlar ve randevu' }, desc: { ar: 'نربطك بمستشفى أو طبيب يفهم لغتك ونتابع موعدك', en: 'We connect you with a hospital or doctor who speaks your language and follow up your appointment', tr: 'Dilinizi konuşan hastane veya doktorla eşleştirir, randevunuzu takip ederiz' } },
  { id: 'health-tourism', category: 'health', type: 'partner', icon: 'heart-pulse', title: { ar: 'السياحة العلاجية (زراعة شعر، أسنان، تجميل)', en: 'Medical tourism (hair, dental, aesthetics)', tr: 'Sağlık turizmi (saç, diş, estetik)' }, desc: { ar: 'علاج بمستوى عالمي بأسعار مناسبة', en: 'Partner coordination for medical tourism options and planning', tr: 'Uygun fiyata dünya standardında bakım' } },

  // ───────────────────────── Education (partner) ─────────────────────────
  { id: 'edu-schools', category: 'education', type: 'partner', icon: 'school', title: { ar: 'تسجيل الأطفال بالمدارس', en: 'School enrollment for children', tr: 'Çocuklar için okul kaydı' }, desc: { ar: 'تسجيل أبنائك في المدارس', en: 'Partner assistance with school registration processes', tr: 'Çocuklarınızı okula kaydetme' } },
  ...
  { id: 'edu-university', category: 'education', type: 'partner', icon: 'graduation-cap', title: { ar: 'اختيار الجامعة والتسجيل الجامعي للأجانب', en: 'University selection & admission for foreigners', tr: 'Yabancılar için üniversite seçimi ve kaydı' }, desc: { ar: 'نساعدك تختار الجامعة والتخصص ثم نتابع القبول والتسجيل', en: 'We help you choose the university and major, then follow admission and enrollment', tr: 'Üniversite ve bölüm seçiminde yardımcı olur, kabul ve kaydı takip ederiz' } },
  ...
  { id: 'legal-ltd', category: 'business', type: 'partner', icon: 'building', title: { ar: 'تأسيس شركة محدودة (Limited)', en: 'Limited company formation', tr: 'Limited şirket kuruluşu' }, desc: { ar: 'تأسيس Limited بالكامل', en: 'Full Limited company setup', tr: 'Eksiksiz Limited şirket kurulumu' } },
  { id: 'legal-as', category: 'business', type: 'partner', icon: 'layers', title: { ar: 'تأسيس شركة مساهمة (Anonim)', en: 'Joint-stock company (Anonim)', tr: 'Anonim şirket kuruluşu' }, desc: { ar: 'تأسيس Anonim Şirket', en: 'Anonim Şirket formation', tr: 'Anonim şirket kurulumu' } },
  ...
  { id: 'biz-licenses', category: 'business', type: 'partner', icon: 'file-check', title: { ar: 'رخص العمل (Ruhsat) — محلات ومطاعم وكافيهات', en: 'Business licenses (Ruhsat) — shops, restaurants & cafés', tr: 'İşyeri ruhsatı — mağaza, restoran ve kafe' }, desc: { ar: 'رخص التشغيل والبلدية والصحة', en: 'Operating, municipality & health permits', tr: 'İşletme, belediye ve sağlık ruhsatları' } },
  ...
  { id: 'daily-moving', category: 'daily', type: 'direct', icon: 'luggage', title: { ar: 'نقل الأثاث (Nakliyat)', en: 'Furniture moving (Nakliyat)', tr: 'Eşya taşıma (Nakliyat)' }, desc: { ar: 'نقل أثاثك بأمان', en: 'Furniture moving and transport assistance', tr: 'Eşyanızı güvenle taşıma' } },
...
export function localizeServiceTitle(titleOrId: string | undefined | null, lang: string): string {
  ...
  // 1. Direct ID match (a merged id resolves to the service that absorbed it)
  const byId = SERVICES.find((s) => s.id === (MERGED_SERVICE_IDS[trimmed] ?? trimmed));
