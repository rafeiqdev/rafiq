...
export const SERVICES: ServiceItem[] = [
  ...
  { id: 'tour-airport', category: 'tourism', type: 'direct', icon: 'plane', title: { ar: 'استقبال وتوصيل المطار', en: 'Airport pickup & drop-off', tr: 'Havalimanı karşılama ve transfer' }, desc: { ar: 'سيارتنا الخاصة وسائق ناطق بالعربية', en: 'Airport transfer coordination through service partners', tr: 'Kendi aracımız, Arapça konuşan şoför' } },
  { id: 'tour-vip', category: 'tourism', type: 'direct', icon: 'star', onRequest: true, title: { ar: 'استقبال VIP من المطار', en: 'VIP airport reception', tr: 'VIP havalimanı karşılama' }, desc: { ar: 'خدمة مميزة — تُسعّر حسب الطلب', en: 'Airport arrival assistance options through service partners', tr: 'Premium — talebe göre fiyatlandırılır' } },
  ...
  { id: 'tr-docs', category: 'translation', type: 'direct', icon: 'file-text', title: { ar: 'ترجمة الوثائق الرسمية', en: 'Document Translation Services', tr: 'Resmî belge tercümesi' }, desc: { ar: 'ترجمة دقيقة لوثائقك', en: 'Translation support for official documents', tr: 'Belgelerinizin doğru tercümesi' } },
  { id: 'tr-medical', category: 'translation', type: 'direct', icon: 'stethoscope', title: { ar: 'الترجمة الطبية المتخصصة', en: 'Medical Interpreting & Translation Support', tr: 'Uzman tıbbi tercüme' }, desc: { ar: 'ترجمة طبية أثناء العلاج', en: 'Language support during medical appointments and document translation', tr: 'Tedavi sırasında tıbbi tercüme' } },
  ...
  { id: 'tel-address', category: 'telecom', type: 'direct', icon: 'map-pin', title: { ar: 'تسجيل العنوان (Adres Kaydı)', en: 'Address registration (Adres Kaydı)', tr: 'Adres kaydı' }, desc: { ar: 'تسجيل عنوان السكن رسمياً', en: 'Assistance with address registration and change procedures', tr: 'İkamet adresini resmen kaydetme' } },

  // ───────────────────────── Health (partner) ─────────────────────────
  { id: 'health-hospitals', category: 'health', type: 'partner', icon: 'building', title: { ar: 'ربط بمستشفيات خاصة (أقسام عربية)', en: 'Private hospitals (Arabic desks)', tr: 'Özel hastaneler (Arapça birimler)' }, desc: { ar: 'مستشفيات بأقسام ناطقة بالعربية', en: 'Help finding private hospital options with language support', tr: 'Arapça birimli hastaneler' } },
  { id: 'health-doctors', category: 'health', type: 'partner', icon: 'stethoscope', title: { ar: 'أطباء ناطقون بالعربية', en: 'Arabic-speaking doctors', tr: 'Arapça konuşan doktorlar' }, desc: { ar: 'ربطك بطبيب يفهم لغتك', en: 'Partner assistance finding doctors who speak your language', tr: 'Dilinizi konuşan doktorla eşleştirme' } },
  { id: 'health-appointments', category: 'health', type: 'partner', icon: 'calendar', title: { ar: 'حجز المواعيد الطبية', en: 'Medical appointment booking', tr: 'Tıbbi randevu alma' }, desc: { ar: 'حجز ومتابعة المواعيد الطبية', en: 'Partner assistance with medical appointment procedures', tr: 'Tıbbi randevu alma ve takip' } },
  ...
  { id: 'daily-marriage', category: 'daily', type: 'direct', icon: 'users', title: { ar: 'الزواج الرسمي للأجانب (إجراءات)', en: 'Marriage registration assistance for foreigners', tr: 'Yabancılar için resmî evlilik' }, desc: { ar: 'إنهاء إجراءات الزواج الرسمي', en: 'Guidance with documents, translations, and appointments for marriage registration', tr: 'Resmî evlilik işlemleri' } },
