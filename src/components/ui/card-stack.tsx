...
// Ported 1:1 from the owner's prompt (2026-09-02). Only change: this is a
// Vite app, not Next.js, so `next/link` became a plain <a>.
    ...
    <div className="relative h-full w-full">
      ...
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-[#EFEADB] text-sm text-muted-foreground">
            No image
          </div>
        )}
      </div>
