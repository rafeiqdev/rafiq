 ...
 */
export function IkametCard({ label, accent = '#1d5f9e' }: { label: string; accent?: string }) {
  return (
    ...
    >
      <defs>
        <linearGradient id={`ik-${label}`} x1="0" y1="0" x2="1" y2="1">
          ...
          <stop offset="100%" stopColor="#163f6b" />
        </linearGradient>
      </defs>

      {/* card body */}
      <rect x="14" y="18" width="312" height="164" rx="16" fill={`url(#ik-${label})`} />
      <rect x="14" y="18" width="312" height="164" rx="16" fill="none" stroke="#f1f8fd" strokeOpacity="0.25" strokeWidth="1.5" />

      {/* header strip */}
      <text x="34" y="48" fill="#f1f8fd" fontFamily="Inter, sans-serif" fontSize="13" fontWeight="800" letterSpacing="1.5">
        T.C. İKAMET İZNİ
      </text>
      <text x="34" y="64" fill="#f1f8fd" fillOpacity="0.7" fontFamily="Inter, sans-serif" fontSize="9" letterSpacing="1">
        RESIDENCE PERMIT
      </text>
      ...
      {/* photo placeholder */}
      <rect x="34" y="84" width="72" height="84" rx="8" fill="#f1f8fd" fillOpacity="0.92" />
      ...
      {/* permit-type label */}
      <text x="166" y="102" fill="#f1f8fd" fontFamily="Inter, sans-serif" fontSize="12" fontWeight="700">
        {label}
      </text>

      {/* data lines */}
      <g fill="#f1f8fd" fillOpacity="0.55">
