...
/**
 * "Order again" on a finished request reopens the SAME order form with the
 * previous area + details pre-filled — never the generic services list, and
 * never an empty form. Rows predating the service_id column keep the old
 * /services fallback.
 */
...
describe('order again reopens the same form, pre-filled', () => {
