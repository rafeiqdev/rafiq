...
vi.mock('../api/analytics', () => ({
  ...
  fetchAnalytics: vi.fn().mockResolvedValue({
    ...
    knownVisitors: 5,
    daily: [
      { day: '2026-09-01', sessions: 12, pageViews: 30 },
      { day: '2026-09-02', sessions: 0, pageViews: 0 },
      { day: '2026-09-03', sessions: 28, pageViews: 60 },
    ],
    visitorsTotal: 2,
    visitors: [
      {
        ...
        pageViews: 3,
        events: 5,
        paths: ['/', '/services', '/services/residency'],
        actions: ['service_click', 'whatsapp_clicked'],
      },
      {
        sessionId: 's2',
        userId: null,
        ...
        lastAt: '2026-09-01T10:01:00.000Z',
        device: 'desktop',
        locale: 'en',
        country: null,
        referrer: null,
    ...
    byDevice: [['mobile', 70]],
    byLocale: [['ar', 80]],
    byCountry: [['TR', 60], ['SY', 20], ['(unknown)', 5]],
