...
const ar: Dict = {
  ...
  'section.today': 'اليوم',
  'section.visitors': 'الزوّار والزيارات',
  ...
  'today.visitorsHint': 'من دخل الموقع، كم زيارة، من أي مصدر، وماذا شاهد — في قسم الزوّار.',
  ...
  'an.whoHint': 'كل سطر زيارة واحدة. اضغط على السطر لترى الصفحات التي فتحها بالترتيب.',
  'an.anonymous': 'زائر غير مسجّل',
  'an.knownNoName': 'مستخدم مسجّل (بلا اسم)',
  'an.direct': 'دخول مباشر',
  'an.pagesShort': 'صفحة',
  'an.journey': 'الصفحات التي فتحها',
  'an.actions': 'ما فعله',
  'an.showAllVisits': 'عرض كل الزيارات',
  'an.visitsTrimmed': 'تُعرض أحدث الزيارات فقط:',
  'an.consentNote': 'تنبيه مهم: لا يُسجَّل أي زائر قبل موافقته على التتبّع في شريط الخصوصية، ولا يُسجَّل من فعّل «عدم التتبّع» في متصفحه. فالأرقام هنا حدّ أدنى مؤكَّد، والزيارات الحقيقية أعلى. ولا نحفظ عنوان IP ولا الموقع الجغرافي، لذلك لا توجد إحصائية بالدول.',
...
const en: Dict = {
  ...
  'section.today': 'Today',
  'section.visitors': 'Visitors & traffic',
  ...
  'an.who': 'Who visited',
  'an.whoHint': 'One row per visit. Open a row to see the pages that visit covered, in order.',
  'an.anonymous': 'Anonymous visitor',
  'an.knownNoName': 'Signed-in user (no name)',
  'an.direct': 'Direct',
  'an.pagesShort': 'pages',
  'an.journey': 'Pages they opened',
  'an.actions': 'What they did',
  'an.showAllVisits': 'Show every visit',
  'an.visitsTrimmed': 'Showing the most recent visits only:',
  'an.consentNote': 'Important: nothing is recorded for a visitor before they accept tracking in the privacy bar, and nothing at all for a browser sending Do Not Track. These figures are a confirmed floor — real traffic is higher. No IP address or location is stored, so there is no country breakdown.',
